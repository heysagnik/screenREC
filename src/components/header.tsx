      ...
      <div className="max-w-7xl mx-auto">
        <div className="px-6 py-3 flex items-center justify-between gap-8">
          <Link href="/zaps" className="flex-shrink-0">
            <Image src="/logo.svg" alt="ScreenREC" width={100} height={28} className="h-7 w-auto" />
          </Link>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Avatar className="h-9 w-9 ring-2 ring-white ring-offset-2 cursor-pointer hover:ring-gray-100 transition-all duration-200">
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-blue-100 to-blue-200 text-blue-700 font-medium">AS</AvatarFallback>
                </Avatar>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-64 p-2 mt-4">
